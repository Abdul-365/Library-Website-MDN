...
exports.bookinstance_delete_get = function (req, res) {
    BookInstance.findById(req.params.id)
        .exec(function (err, book_instance) {
            ...
            res.render('bookinstance_delete', {title: 'Delete Instance', book_instance: book_instance})
        })
};
...
exports.bookinstance_delete_post = function (req, res) {
    BookInstance.findById(req.params.id)
        .exec(function (err, book_instance) {
            ...
            BookInstance.findByIdAndRemove(req.body.book_instance_id, function delete_book_instance(err) {
                if(err) {return next(err);}
                res.redirect('/catalog/bookinstances')
            })
        })
